          ...
          {activeTab === "security" && (
            <div className="bg-surface rounded-2xl border border-border p-6 shadow-xs max-w-xl animate-in fade-in">
              ...
              <form onSubmit={handleSecurityUpdate} className="space-y-4">
                ...
                <div><label className="text-[10px] font-bold uppercase tracking-wider text-slate-500 block mb-1">New Password</label><input type="password" required value={secNewPass} onChange={e=>setSecNewPass(e.target.value)} className="w-full p-2.5 rounded-lg border border-border text-xs outline-none focus:border-primary" placeholder="Min 6 characters"/></div>
                <div><label className="text-[10px] font-bold uppercase tracking-wider text-slate-500 block mb-1">Confirm New Password</label><input type="password" required value={secConfirmPass} onChange={e=>setSecConfirmPass(e.target.value)} className="w-full p-2.5 rounded-lg border border-border text-xs outline-none focus:border-primary" /></div>
